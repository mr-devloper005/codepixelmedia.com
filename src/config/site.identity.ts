export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'q8v1m4kx',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Code Pixel Media',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'codepixelmedia.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://codepixelmedia.com',
