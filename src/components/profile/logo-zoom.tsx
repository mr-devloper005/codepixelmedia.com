...
interface LogoZoomProps {
  logoUrl?: string;
  brandName: string;
}

export function LogoZoom({ logoUrl, brandName }: LogoZoomProps) {
  ...
  return (
    <>
      <button
        ...
        className="group relative h-24 w-24 overflow-hidden rounded-2xl border-4 border-white bg-white shadow-xl transition hover:scale-105"
      >
